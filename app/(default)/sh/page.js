                ...
                <div className="mx-auto block items-center bg-gray-800 rounded-lg shadow-xl max-w-[100rem] p-10 mt-10 row text-left">
                    <div className="item- px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                        ...
                        <div className="grid mx-auto items-center gap-2">
                            <p className='inline-flex items-baseline gap-1'>Click on the icon to copy the code below  <CC content={"wget -q https://scripts-api.stratostech.xyz/sh?file=Docker%20Install/docker.sh -O install.sh; sudo bash ./install.sh"} /></p>
                        ...
                        <div className="grid mx-auto items-center gap-2">
                            <p className='inline-flex items-baseline gap-1'>Click on the icon to copy the code below  <CC content={"wget -q https://scripts-api.stratostech.xyz/sh?file=Node%20Install/node.sh -O install.sh; sudo bash ./install.sh"} /></p>
                            <SyntaxHighlighter language="bash" style={tomorrow} className="drop-shadow-xl">
